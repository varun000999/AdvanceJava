...
<form:form id="myform" modelAttribute="employeedetails" method="post">
	<table>
		...
		<tr>
			...
			<td >Employee Name </td>
			<td >: 
			<form:input  value="${employee.employee_name}" type='text' path="employee_name" />
			<font color="red">${nameerrorMessage}</font>
			</td>
		</tr>
		<tr>
			<td >Location </td>
			<td >: <form:input  value="${employee.location}" type='text' path="location" />
			<font color="red">${locationerrorMessage}</font>
			</td>
		</tr>
		<tr>
			<td >Email </td>
			<td >: <form:input value="${employee.email}" type='text' path="email"  />
			<font color="red">${emailerrorMessage}</font>
			</td>
		</tr>
		<tr>
			<td >Date Of Birth </td>
			<td ">: <form:input value="${employee.date_of_birth}" type='text' path="date_of_birth" /></td>
		</tr>
		<tr>
		<td>
